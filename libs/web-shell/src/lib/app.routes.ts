...
export const appRoutes: Routes = [
...

  {
    ...
    loadChildren: () =>
      import('@hhsc-compliance/compliance').then(
        (m: typeof import('@hhsc-compliance/compliance')) =>
          m.COMPLIANCE_ROUTES,
      ),
  },

  {
    ...
    loadChildren: () =>
      import('@hhsc-compliance/residential').then(
        (m: typeof import('@hhsc-compliance/residential')) =>
          m.RESIDENTIAL_ROUTES,
      ),
  },

  {
    ...
    loadComponent: () =>
      import('@hhsc-compliance/programmatic').then((m) => m.Programmatic),
  },
...

  {
    ...
    loadComponent: () =>
      import('@hhsc-compliance/enclosed-beds').then((m) => m.EnclosedBeds),
  },
...

  {
    ...
    loadComponent: () =>
      import('@hhsc-compliance/prohibitions').then((m) => m.Prohibitions),
  },
